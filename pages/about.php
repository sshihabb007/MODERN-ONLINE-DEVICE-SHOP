...
<h1 class="font-display text-display text-primary text-glow">The Axiom Vision</h1>
<p class="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">
                    Providing next-gen, cyber-luxe hardware. We forge high-fidelity digital infrastructure and engineer the future of elite technological experiences for creators and professionals.
                </p>
...
<img alt="Cyber-luxe Hardware" class="w-full aspect-[3/4] object-cover rounded-xl filter grayscale contrast-125 brightness-90 group-hover:grayscale-0 transition-all duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAbo9d6vksgWVM0FGFHibXTL5ACIsN1U3Viku0cixwg3mLCSZSiWFJ2zAkJulzBw79975T4GCNq6OGeW3-tV1MN70w0qnHipA35Fo7tW1HECQutLAw0Q9s-qVOuQxYmpr64MtkjlMLk0Zkw6STCenBRc_kbMkmNEjB7oP-rNuLqqpbA-jQbOQ7peMFDDQKtnwvQ0APav_lwiWRWzAadA4cbmrCNxuDuxKJetVbIBoxXlbcl2DjcAy0kBfMlHpjRoc-yZ2LeVFi_KbHV"/>
...
<span class="font-label-caps text-label-caps text-primary">Systems Active</span>
</div>
</div>
...
<span class="material-symbols-outlined text-[120px] leading-none text-primary-fixed-dim">hardware</span>
</div>
<p class="font-body-lg text-body-lg text-on-surface-variant relative z-10">
                        Curating robust, high-performance hardware and immersive technological experiences. The focus is on providing next-gen, cyber-luxe devices that bridge complex data models with intuitive, high-performance user interfaces. It's not just about selling electronics; it's about constructing a flawless digital ecosystem where security, speed, and elegance converge.
                    </p>
</div>
</div>
</section>
<div class="refractive-divider mb-24"></div>
<!-- Our Journey (Company Milestones) -->
<section class="mb-24">
...
<div class="flex-1">
<span class="font-label-caps text-label-caps text-secondary-fixed-dim mb-2 block">Phase Alpha</span>
<h3 class="font-h3 text-h3 text-primary mb-2">Founding the Vault</h3>
<p class="font-body-md text-body-md text-on-surface-variant">Establishing the foundational architecture for our cyber-luxe hardware distribution network and curating our first line of elite components.</p>
</div>
<div class="w-full md:w-48 h-32 rounded-lg overflow-hidden relative">
<img alt="Vault Initialization" class="w-full h-full object-cover filter grayscale hover:grayscale-0 transition-all duration-500" src="https://lh3.googleusercontent.com/aida/ADBb0ugIPenP46UGWNl0caGNtH_wV2JSmvVkz6Dw4qtoW4or0gFqFqKnWVp289ZQs4vdoCtcl06yCLa8o29ODTTz8nPhDleAbGlogSUNESaE24qdCYNhoS08ZOwi4WwTaGcRN5QrEYYvcwxlXUmuQtb8sMPJI-eqYlWMbeKpIyvxxn178pNCl-PnSSV0mtRVhfQbkWTvvJZfXUiPGwtnGKVWDA4EezFHQdDjvnYl5JpRnjmz5jBK72UyFBEfsJAX"/>
...
<div class="glass-panel p-6 rounded-xl group-hover:border-primary-fixed-dim/50 transition-colors flex flex-col md:flex-row gap-stack-md items-center">
<div class="flex-1">
<span class="font-label-caps text-label-caps text-secondary-fixed-dim mb-2 block">Phase Beta</span>
<h3 class="font-h3 text-h3 text-primary mb-2">The First Quantum Shift</h3>
<p class="font-body-md text-body-md text-on-surface-variant">Scaling our operations to support global logistics and integrating next-gen security protocols for flawless transactions.</p>
</div>
</div>
</div>
<!-- Milestone 3 -->
...
<div class="glass-panel p-6 rounded-xl group-hover:border-primary-fixed-dim/50 transition-colors flex flex-col md:flex-row gap-stack-md items-center">
<div class="flex-1">
<span class="font-label-caps text-label-caps text-secondary-fixed-dim mb-2 block">Phase Gamma</span>
<h3 class="font-h3 text-h3 text-primary mb-2">Global Expansion</h3>
<p class="font-body-md text-body-md text-on-surface-variant">Achieving worldwide reach with a decentralized network of high-fidelity tech hubs, bringing cyber-luxe hardware to professionals everywhere.</p>
</div>
<div class="w-full md:w-48 h-32 rounded-lg overflow-hidden relative">
<img alt="Global Network Expansion" class="w-full h-full object-cover filter grayscale hover:grayscale-0 transition-all duration-500" src="https://lh3.googleusercontent.com/aida/ADBb0uhN5co7EVf8fG4cOFcIhlib4jylCSOEDMumrGYrli0OThj3EfZo-qqnWg1WAFNS03Rr7o8vL8UyF1YayXr3X1WAUPVd_dooqOnI3M7hcwQnHNEJ1Hc9klSSrUUuoyij5nmPise9Vmrnt9lk7DTWnXgXrnqJkm8bKP0qqGNI-uRCQoujd4LxGpXFy8uXwLyfQ3sayta8ZcZDmk7UoHJGFztUKqgs_ccauT0xDFbjTK4bT4t4wQaeimZ0CL6y"/>
<div class="absolute inset-0 bg-gradient-to-t from-surface to-transparent opacity-60"></div>
</div>
</div>
</div>
